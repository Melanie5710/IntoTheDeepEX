...
public class main extends OpMode {
    ...
    public static final double CLAW_CLOSE = 0.51;
    public static final double CLAW_OPEN = 0.655;
    public static final double UP = 0.5167;
    public static final double DOWN = 0.3822222222222222222;
    public static final double RELEASE = 0.86944444444;
